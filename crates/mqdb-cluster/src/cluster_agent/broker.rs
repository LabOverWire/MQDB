...
use mqdb_agent::topic_protection::TopicProtectionAuthProvider;
use mqtt5::QoS;
...
use mqdb_agent::broker_defaults::{
    BROKER_MAX_CLIENTS, BROKER_MAX_PACKET_SIZE, SESSION_EXPIRY_SECS,
};
...
impl ClusteredAgent {
    ...
    > {
        ...
        let auth_result =
            mqdb_agent::auth_config::configure_broker_auth(&auth_cfg, &mut temp_auth_config)
                .await
    ...
    fn build_auth_setup_config(&self) -> mqdb_agent::auth_config::AuthSetupConfig {
        mqdb_agent::auth_config::AuthSetupConfig {
    ...
    async fn configure_broker_with_auth(
        ...
        auth_result: mqdb_agent::auth_config::AuthSetupResult,
    ) -> Result<
        (
            BrokerConfig,
            Option<String>,
