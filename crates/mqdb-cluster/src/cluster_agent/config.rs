...
impl ClusterConfig {
    ...
    pub fn new(node_id: u16, db_path: PathBuf, peers: Vec<super::PeerConfig>) -> Self {
        Self {
            ...
            password_file: None,
            acl_file: None,
            auth_setup: mqdb_agent::auth_config::AuthSetupConfig::default(),
            quic: QuicConfig {
                enabled: true,
    ...
    #[must_use]
    pub fn with_auth_setup(mut self, config: mqdb_agent::auth_config::AuthSetupConfig) -> Self {
    ...
    #[must_use]
    pub fn with_ownership(mut self, ownership: mqdb_core::types::OwnershipConfig) -> Self {
