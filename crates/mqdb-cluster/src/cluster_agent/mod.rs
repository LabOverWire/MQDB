...
pub enum ClusterInitError {
    ...
    StorageOpen {
        path: PathBuf,
        source: mqdb_core::error::Error,
    },
    RaftInit(mqdb_core::error::Error),
}
...
pub struct ClusterConfig {
    ...
    pub auth_setup: mqdb_agent::auth_config::AuthSetupConfig,
    pub quic: QuicConfig,
...
pub struct ClusteredAgent {
    ...
    auth_setup: mqdb_agent::auth_config::AuthSetupConfig,
    quic: QuicConfig,
